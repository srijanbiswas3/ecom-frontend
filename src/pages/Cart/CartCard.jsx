        ...
        <div className='rounded-xl  bg-slate-100 p-2 m-1'>
            ...
            <div className="flex justify-between  font-medium">
                <div className='flex items-center'>
                    <img src={cartItem?.productImage} alt="" className="h-32 rounded-lg cursor-pointer mr-5 " onClick={() => navigate(`/products/${cartItem?.productId}`, { state: { productId: cartItem?.productId } })} />
                    <div >
                        ...
                        <div className="md:flex items-center">
                            ...
                            <Select value={qty.toString()} defaultValue={qty.toString()} onValueChange={(value) => { setQty(value); updateQty(cartItem?.productId, value) }}>
                                <SelectTrigger className="w-16 md:m-3">
                ...
                <div className="flex flex-col justify-center mr-5">
                    ...
                    {qty} X <del>Rs.{cartItem?.productPrice}</del>
                    Rs.{cartItem?.productDiscountedPrice}
